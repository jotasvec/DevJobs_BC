...
const JobCard = ({ card }) => {
    ...
    return (
        <article className="flex items-start justify-between gap-6 p-5 bg-card border border-white/8 rounded-xl transition-all duration-150 hover:border-accent/20 hover:-translate-y-0.5">
